...
**ВІДКАТИ (усі без зміни коду):** `MEXC_PATH_MODE=bare` · `MEXC_DOLOS_ON_ORDER=0` · `MEXC_DOLOS_LEGACY=1` (стара пара chash+поля ордера) · `MEXC_CHASH=973e5a66…` · `MEXC_DEVICE_PROFILE=0` · `MEXC_CHROME_VER=…`
