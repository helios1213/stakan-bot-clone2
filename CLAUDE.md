...
**ВІДКРИТЕ:** `signal_features` заповнить диск сама — ретенція 30 днів, накопичено 19 = 3.64G, ~190 МБ/добу, сталий стан ≈5.7G при 2.3G вільних. 14 днів звільнили б ~1.9G. Рішення оператора. · Латч акаунт-рівневої відмови (`6002`/`6026`/`6028`) — оператор скіпав двічі; ціна виміряна: під час епізоду 52% спроб PEPE згорали. · Поведінковий тест живого шляху для ручок shadow — не зроблено, і без нього їх вмикати не можна.
