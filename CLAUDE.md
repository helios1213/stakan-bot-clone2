...
- Активні кампанії: клон слот 1 і слот 2 (по 3 доби, вимикають себе самі), primary слот 1.
...
**ЩО ЗНАТИ ПРО ОБЛІК — він переписувався 6 разів за день, і ось фінальна модель:**
```
...
**Дев'ять разів за сесію мутант ловив діру «формула правильна, але не викликається».** Кожен новий шматок логіки має тест ПРОВОДКИ, а не лише самої функції. Це найчастіша помилка в цьому коді.
