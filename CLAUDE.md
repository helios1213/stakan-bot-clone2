...
- **ПОБІЧНИЙ ЕФЕКТ ПОРОГУ, який варто знати:** розпродаж наприкінці кампанії теж гейтиться `_spot_viable`. Слот, що просів нижче порога, **не продасть** свої монети — вони лишаться замкненими. Спотова вартість міряється як «вільний USDT + монети», тож це рідко, але поріг 20 розширює цю смугу проти 10.
